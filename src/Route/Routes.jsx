...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/forms/widget/timepicker/:layout`, Component: <Timepicker /> },
  ...
  { path: '/product/rdps', Component: <RDPS /> },
  { path: '/product/root-sshwhmvps', Component: <RSWV /> },
  { path: '/product/cpanels', Component: <Cpanel /> },
  { path: '/product/shells', Component: <Shell /> },
  { path: '/product/smtpswebmail', Component: <SMTP /> },
  { path: '/product/phpmailers', Component: <PHPMailer /> },
  { path: '/product/leads', Component: <Leads /> },
  { path: '/product/premium_shop_dating', Component: <Accounts /> },
  { path: '/product/programsscripts', Component: <Programs /> },
  { path: '/product/bank', Component: <Methods /> },
  { path: '/user/tickets', Component: <Ticket /> },
