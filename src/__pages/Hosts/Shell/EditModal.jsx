...
import { edit_shell } from "../../../redux/actions/shell";

const EditModal = (props) => {
  const { selected_shell } = useSelector((state) => state.shell);

  const [formData, setFormData] = useState(selected_shell);

  useEffect(() => {
    setFormData(selected_shell);
  }, [selected_shell]);
