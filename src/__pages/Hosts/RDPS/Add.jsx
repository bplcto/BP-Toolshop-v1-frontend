...
function Add() {
  ...
  return (
    <Fragment>
      <Btn
        attrBtn={{
          className: "shadow-sm shadow-showcase",
          style: addBtnStyle,
          onClick: toggle,
        }}
      >
      ...
      <Modal isOpen={modal} toggle={toggle} size="lg" centered>
        <ModalHeader toggle={toggle}>Add Smtps</ModalHeader>
        <ModalBody>
          <Form>
              ...
              <TabContent activeTab={active}>
                <TabPane className="fade show" tabId="inputs">
                  <Alerts attrAlert={{ color: "primary dark" }}>
                    {"Each Smtps in one line, Delimiter |."}
                    <br />
                  ...
                  <FormGroup>
                    ...
                    <Input
                      type="textarea"
                      placeholder="Ex: Host|Port|Username|Password|Price"
                      rows="5"
                      name="smtps"
                      onChange={onChange}
                    />
